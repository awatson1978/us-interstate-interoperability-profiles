...
* policy.authority = "https://www.maine.gov/"
* verification 1..*
...
Instance: MaineConsentProfile
InstanceOf: Consent
Title: "Consent Record - Maine"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T16:11:20.407Z"
* organization = Reference(ME) "State of Maine"
