Profile:  LouisianaConsentProfile
Parent:   Consent
Id:       louisiana-consent-profile
Title:    "LouisianaConsentProfile"
Description: "Louisiana consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://www.louisiana.gov/"
* verification 1..*
...
Instance: LouisianaConsentProfile
InstanceOf: Consent
Title: "Consent Record - Louisiana"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T15:59:17.253Z"
* organization = Reference(LA) "State of Louisiana"
