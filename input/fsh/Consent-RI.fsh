Profile:  RhodeIslandConsentProfile
Parent:   Consent
...
* policy.authority = "https://www.ri.gov/"
* verification 1..*
...
Instance: RhodeIslandConsentProfile
InstanceOf: Consent
Title: "Consent Record - Rhode Island"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T17:11:31.826Z"
* organization = Reference(RI) "State of Rhode Island"
