Profile:  WestVirginiaConsentProfile
Parent:   Consent
Id:       west-virginia-consent-profile
Title:    "WestVirginiaConsentProfile"
Description: "West Virginia consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://www.wv.gov/"
* verification 1..*
...
Instance: WestVirginiaConsentProfile
InstanceOf: Consent
Title: "Consent Record - West Virginia"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T17:45:16.035Z"
* organization = Reference(WV) "State of West Virginia"
