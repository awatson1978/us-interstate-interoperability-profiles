Profile:  ConnecticutConsentProfile
Parent:   Consent
Id:       connecticut-consent-profile
Title:    "ConnecticutConsentProfile"
Description: "Connecticut consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://portal.ct.gov/"
* verification 1..*
...
Instance: ConnecticutConsentProfile
InstanceOf: Consent
Title: "Consent Record - Connecticut"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T15:04:13.178Z"
* organization = Reference(CT) "State of Connecticut"
