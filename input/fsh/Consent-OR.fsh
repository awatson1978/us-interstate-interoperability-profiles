Profile:  OregonConsentProfile
Parent:   Consent
Id:       oregon-consent-profile
Title:    "OregonConsentProfile"
Description: "Oregon consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://www.oregon.gov/"
* verification 1..*
...
Instance: OregonConsentProfile
InstanceOf: Consent
Title: "Consent Record - Oregon"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T16:55:29.819Z"
* organization = Reference(OR) "State of Oregon"
...
* provision.provision[=].code.text = "Assisted suicide"
* provision.provision[=].code =  http://snomed.info/sct#51709005 "Assisted suicide (event)"
* provision.provision[+].type = #permit
