Profile:  VermontConsentProfile
Parent:   Consent
Id:       vermont-consent-profile
Title:    "VermontConsentProfile"
Description: "Vermont consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://www.vermont.gov/"
* verification 1..*
...
Instance: VermontConsentProfile
InstanceOf: Consent
Title: "Consent Record - Vermont"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T17:42:14.002Z"
* organization = Reference(VT) "State of Vermont"
