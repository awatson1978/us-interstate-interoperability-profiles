Profile:  OklahomaConsentProfile
Parent:   Consent
...
* policy.authority = "https://oklahoma.gov/"
* verification 1..*
...
Instance: OklahomaConsentProfile
InstanceOf: Consent
Title: "Consent Record - Oklahoma"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T16:53:28.276Z"
* organization = Reference(OK) "State of Oklahoma"
