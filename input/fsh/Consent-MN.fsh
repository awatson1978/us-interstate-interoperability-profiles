Profile:  MinnesotaConsentProfile
Parent:   Consent
...
Instance: MinnesotaConsentProfile
InstanceOf: Consent
Title: "Consent Record - Minnesota"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T16:15:45.315Z"
* organization = Reference(MN) "State of Minnesota"
