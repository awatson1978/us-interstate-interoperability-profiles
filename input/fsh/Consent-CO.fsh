...
* policy.authority = "https://www.colorado.gov/"
* verification 1..*
...
Instance: ColoradoConsentProfile
InstanceOf: Consent
Title: "Consent Record - Colorado"
Usage: #example
* status = #active
* category[0].coding[0].code = http://loinc.org#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T14:58:27.319Z"
* organization = Reference(CO) "State of Colorado"
