Profile:  MarylandConsentProfile
Parent:   Consent
Id:       maryland-consent-profile
Title:    "MarylandConsentProfile"
Description: "Maryland consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://www.maryland.gov/"
* verification 1..*
...
Instance: MarylandConsentProfile
InstanceOf: Consent
Title: "Consent Record - Maryland"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T16:02:07.020Z"
* organization = Reference(MD) "State of Maryland"
