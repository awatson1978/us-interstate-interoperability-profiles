Profile:  CaliforniaConsentProfile
Parent:   Consent
Id:       california-consent-profile
Title:    "CaliforniaConsentProfile"
Description: "California consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://www.ca.gov/"
* verification 1..*
...
Instance: CaliforniaConsentProfile
InstanceOf: Consent
Title: "Consent Record - California"
Usage: #example
* status = #active
* category[0].coding[0].code = http://loinc.org#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T14:49:20.995Z"
* organization = Reference(CA) "State of California"
