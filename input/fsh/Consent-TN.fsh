Profile:  TennesseeConsentProfile
Parent:   Consent
Id:       tennessee-consent-profile
Title:    "TennesseeConsentProfile"
Description: "Tennessee consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://www.tn.gov/"
* verification 1..*
...
Instance: TennesseeConsentProfile
InstanceOf: Consent
Title: "Consent Record - Tennessee State"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T17:32:17.695Z"
* organization = Reference(TN) "State of Tennessee"
