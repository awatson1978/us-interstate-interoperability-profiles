Profile:  PennsylvaniaConsentProfile
Parent:   Consent
...
* policy.authority = "https://www.pa.gov/"
* verification 1..*
...
Instance: PennsylvaniaConsentProfile
InstanceOf: Consent
Title: "Consent Record - Pennsylvania"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T16:57:23.718Z"
* organization = Reference(PA) "State of Pennsylvania"
