Profile:  MontanaConsentProfile
Parent:   Consent
Id:       montana-consent-profile
Title:    "MontanaConsentProfile"
Description: "Montana consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://mt.gov/"
* verification 1..*
...
Instance: MontanaConsentProfile
InstanceOf: Consent
Title: "Consent Record - Montana"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T16:24:13.174Z"
* organization = Reference(MT) "State of Montana"
