Profile:  NewJerseyConsentProfile
Parent:   Consent
Id:       new-jersey-consent-profile
Title:    "NewJerseyConsentProfile"
Description: "New Jersey consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://nj.gov/"
* verification 1..*
...
Instance: NewJerseyConsentProfile
InstanceOf: Consent
Title: "Consent Record - New Jersey"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T16:35:56.722Z"
* organization = Reference(NJ) "State of New Jersey"
