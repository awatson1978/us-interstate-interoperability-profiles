...
* policy.authority = "https://www.iowa.gov/"
* verification 1..*
...
Instance: IowaConsentProfile
InstanceOf: Consent
Title: "Consent Record - Iowa"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T15:30:40.410Z"
* organization = Reference(IA) "State of Iowa"
