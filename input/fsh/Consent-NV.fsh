Profile:  NevadaConsentProfile
Parent:   Consent
Id:       nevada-consent-profile
Title:    "NevadaConsentProfile"
Description: "Nevada consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://nv.gov/"
* verification 1..*
...
Instance: NevadaConsentProfile
InstanceOf: Consent
Title: "Consent Record - Nevada"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T16:40:43.264Z"
* organization = Reference(NV) "State of Nevada"
