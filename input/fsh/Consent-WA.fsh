Profile:  WashingtonConsentProfile
Parent:   Consent
Id:       washington-consent-profile
Title:    "WashingtonConsentProfile"
Description: "Washington consent profile."

* policyRule from ConsentExchangePolicies
* policy.authority = "https://access.wa.gov/"
* verification 1..*
...
Instance: WashingtonConsentProfile
InstanceOf: Consent
Title: "Consent Record - Washington"
Usage: #example
* status = #active
* category = $loinc#57017-6 "Privacy policy Organization Document"
* scope = $consentscope#patient-privacy "Privacy Consent"
* dateTime = "2024-01-29T17:43:45.470Z"
* organization = Reference(WA) "State of Washington"
